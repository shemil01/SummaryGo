import { FileText, MoveRight, Pizza } from "lucide-react";
...
const steps: Step[] = [
  {
    ...
    description: "Upload you PDF file to get started",
  },
  {
    icon: <FileText size={64} strokeWidth={1.5} />,
    label: "Upload Your PDF",
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2.2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.4%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 56.7%, 0.1% 64.4%, 9% 17.9%, 100% 27.6%, 76.8% 76.1%, 97.7% 74.1%, 74.1% 44.1%)",
            }}
          />
        </div>
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full ">
